...
//    	window.location.href = "addBase_customer.html?type=3";
//    	$('#J_menuItem').attr('href','customer/addBase_customer.html?type=3');
//    });
...
//bootstrapTable初始化参数
var init = {
    url: '/xxm/rest/baseCustomer/baseCustomerService/contractBaseCustomer', //请求后台的URL（*）
    method: 'post',                      //请求方式（*）
    ajaxOptions: {
        async: false // 设置为异步
    },
