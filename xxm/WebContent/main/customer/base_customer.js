...
//    	window.location.href = "addBase_customer.html?type=1";
//    	$('#J_menuItem').attr('href','customer/addBase_customer.html?type=1');
//    });
...
//bootstrapTable初始化参数
var init = {
    url: '/xxm/rest/baseCustomer/baseCustomerService/findBaseCustomerList', //请求后台的URL（*）
    method: 'post',                      //请求方式（*）
    ajaxOptions: {
        async: false // 设置为异步
    },
