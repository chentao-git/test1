$(function() {
	...
	mask_fullscreen();
	// 初始化table并刷新数据
	$('#tbSpRepertory').bootstrapTable(init);
	// 初始化时间控件
	initDateControl();
	// 查询Button的点击事件
	$("#btnQuery").click(function() {
		//加载效果
		mask_fullscreen();
		$("#tbSpRepertory").bootstrapTable('refresh', init);
	});
});
...
//	result += '<a class="J_menuItem" href="install/install_list.html?gpsId= \"showModal(3,'+ value + ')\"">安装</a>';
	return result;
