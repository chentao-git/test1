...
//    	window.location.href="addProduct.html";
    	$('#J_menuItem').attr('href','product/addProduct.html');
    });
...
var actionFormatter = function(value, row, index) {
    var result = "";
        result += "<a class='J_menuItem'  href='product/contract_allocation.html?productId="+value+"'  >合同配置</a>";
...
//bootstrapTable初始化参数
var init = {
    url: '/xxm/rest/productList/productService/findProductList', //请求后台的URL（*）
    method: 'post',                      //请求方式（*）
    ajaxOptions: {
        async: false // 设置为异步
    },
	...
	columns: [{
			...
			field: 'suggestApplyAmount',
			title: '建议申请数额(元)',
			sortable : true
		},{
			field: 'minApplyAmount',
			title: '最低申请数额(元)',
			sortable : true
			
		},{
			field: 'maxApplyAmount',
			title: '最高申请数额(元)',
			sortable: true
		},{
			field: 'rateMethodName',
			title: '利率计算方式',
			sortable : true
		},{
			field: 'rate',
