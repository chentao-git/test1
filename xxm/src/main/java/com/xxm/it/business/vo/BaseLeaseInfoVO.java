...
public class BaseLeaseInfoVO extends CommonVO {
	@XmlTransient
	private static final long serialVersionUID = 1L;
	@XmlTransient
	private String leaseInfoId;
	@XmlTransient
	private String baseLeaseInfoId;//租赁信息ID
	@XmlTransient
	private String carTypeVL;//车产类型，主车/挂车
	@XmlTransient
	private String carTypeVLName;//车产类型名称，主车/挂车
	@XmlTransient
	...
	@XmlTransient
	private String usesTpName;//车辆用途名称
	@XmlTransient
	private String status; //状态  0为可查  1为删除
	 ...
	 @XmlTransient
	 private String useNatureName;//原车辆使用性质
	 @XmlTransient
	 private String usesTp;//车辆用途 
	 
	 @XmlElement(name="RunAreaName")
	 private String runAreaName;//车险保单号
	 @XmlElement(name="StartSiteName")
	 private String startSiteName;//续保车险保单号一
	 @XmlElement(name="LicenseNo")
	 private String plateNumber; //车牌号
	 @XmlElement(name="LicenseTypeProductConfig")
	 private String licenseTypeProductConfig;//种类
	 @XmlTransient
	 private String licenseTypeProductConfigName;//种类名称
	 @XmlElement(name="LicenseColorCodeProductConfig")
	 private String licenseColorCodeProductConfig;//底色
	 @XmlElement(name="CarKindCode")
	...
	public String getUsesTpName() {
		return usesTpName;
	}
	public void setUsesTpName(String usesTpName) {
		this.usesTpName = usesTpName;
	}
	...
	public String getLeaseholdUseName() {
		return leaseholdUseName;
	}
	public void setLeaseholdUseName(String leaseholdUseName) {
		this.leaseholdUseName = leaseholdUseName;
	}
	public String getLicenseTypeProductConfigName() {
		return licenseTypeProductConfigName;
	}
	public void setLicenseTypeProductConfigName(String licenseTypeProductConfigName) {
		this.licenseTypeProductConfigName = licenseTypeProductConfigName;
	}
